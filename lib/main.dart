  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MultiBlocProvider(
        providers: [
          BlocProvider<ServiceActionBloc>(builder: (_) => ServiceActionBloc(),),
        ],
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    ...
    bloc = BlocProvider.of<ServiceActionBloc>(context);
  }

  void _incrementCounter() {
    bloc.dispatch(WarrantyActionEvent(actionBean));
  }
        ...
        child: BlocListener(
          ...
          listener: (_, BaseServiceState state) {
            if (state is ServiceActionState) {
              if (state.actionBean.currentHeaderFlag == ActionHeaderFlag.warranty) {
                actionBean.warranty = state.actionBean.warranty;
              }
            }
          },
          child: BlocBuilder(
            ...
            builder: (_, BaseServiceState state) {
              return Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                    actionBean.warranty ? 'click' : 'cancel click',
